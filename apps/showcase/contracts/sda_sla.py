...
# }
"""SDA — SLA variant. One treasury + one price monitor + tick(). ~7KB"""
import json, typing
...
class SlaAccount(gl.Contract):
    ...
    @gl.public.write
    def set_sla_monitor(self, url:str, clause:str, per_action:str="150", recipient:str="", source_account:str="ops")->str:
        me=gl.message.sender_address.as_hex.lower().removeprefix("0x")
        if me!=self.owner.get("owner"): raise ValueError("not owner")
        ...
        return "monitor_set"
    @gl.public.write
    def tick_sla(self, tick_id:str)->typing.Any:
